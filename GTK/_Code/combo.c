...
int main(int argc, char *argv[])
{
    ...
    gtk_window_set_title(GTK_WINDOW(window), "Linux Family");
    ...
    gtk_combo_box_append_text(GTK_COMBO_BOX(combo), "Redhat");
    gtk_combo_box_append_text(GTK_COMBO_BOX(combo), "Red Hat Enterprise Linux");
    gtk_combo_box_append_text(GTK_COMBO_BOX(combo), "Fedora");
    gtk_combo_box_append_text(GTK_COMBO_BOX(combo), "Centos");
